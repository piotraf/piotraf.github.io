...
local-data: "ns1.example.com.  IN A 192.168.56.254"
local-data-ptr: "192.168.56.254  ns1.example.com"
local-data-ptr: "192.168.56.1  vbox.example.com"
local-data: "vbox.example.com.  IN A 192.168.56.1"
###############
EOF
...
firewall-cmd --reload
nmcli c m 'System enp0s3' ipv4.dns '192.168.56.254'  +ipv4.ignore-auto-dns 'yes'
...
range 192.168.56.240 192.168.56.249;
#host workstation {
